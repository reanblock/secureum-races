...
// imports used in InSecureumLand contract
...
// imports used in PatrickInTheGym contract (that uses the VRFConsumerBaseV2)
...
contract InSecureumLand is ERC721Enumerable, Ownable, ReentrancyGuard, VRFConsumerBase {
   ...
   constructor(
        ...
        uint256 _vrfFee,
        address _operator
   ) ERC721(name, symbol) VRFConsumerBase(_vrfCoordinator, _linkTokenAddress) Ownable(msg.sender) {
...
/*
    Included this example to show using VRFConsumerBaseV2 (solution for Q6)
    Source https://blog.developerdao.com/the-developers-guide-to-chainlink-vrf-foundry-edition
*/
