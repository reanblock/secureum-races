...
import {R0_Q6} from "../src/RACE0Q6.sol";
...
contract R0Q6Test is Test { 
    ...
    function setUp() public {
        ...
        address(r0_q6).call{value: depositAmount}("");
    }
    ...
    function test_missingCheckOnUserBalanceInWithdraw() public {
        ...
        assertEq(address(r0_q6).balance, depositAmount);

        // attacker calls withdraw for the deposit amount (balance of the tartget)
        vm.prank(attacker);
        r0_q6.withdraw(depositAmount);
    ...
    function test_IntegerUnderflowLeadingToWrapping() public {
        ...
        assertEq(r0_q6.balances(attacker), 0);
        ...
        assertEq(r0_q6.balances(attacker), type(uint256).max);
    }
}